...
// .from('.bg-img',{top:`${document.querySelector('.bg-img').offsetHeight /2 -200}px`,duration:2},'a')
...
tl.from('.text h1',{y:`${window.innerHeight - document.querySelector('.text h1').getBoundingClientRect().top}px`,duration:1},)
.from('.box-three',{y:`${window.innerHeight - document.querySelector('.box-three').getBoundingClientRect().top}px`,duration:1},)
